(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('crypto'), require('fs'), require('path'), require('http'), require('net'), require('tls'), require('url'), require('https'), require('util'), require('events'), require('tty'), require('os'), require('domain'), require('module'), require('console')) :
	typeof define === 'function' && define.amd ? define(['crypto', 'fs', 'path', 'http', 'net', 'tls', 'url', 'https', 'util', 'events', 'tty', 'os', 'domain', 'module', 'console'], factory) :
	(global = global || self, global.npmPackageES6Boilerplate = factory(global.crypto, global.fs$1, global.path$1, global.http$1, global.net, global.tls, global.url, global.https, global.util, global.events, global.tty, global.os, global.domain, global.module, global.console$2));
}(this, function (crypto, fs$1, path$1, http$1, net, tls, url, https, util, events, tty, os, domain, module, console$2) { 'use strict';
